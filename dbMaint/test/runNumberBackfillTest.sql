...
update RunNumber as R, Exception as E set R.runNumber = CONCAT(R.id, "T"), R.runInt=R.id  where R.runNumber is NULL and R.rootActivityId NOT IN(E.NCRActivityId);
