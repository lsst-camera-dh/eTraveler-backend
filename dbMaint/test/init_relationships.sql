...
insert into MultiRelationshipSlotType set slotname='uniqueSlot', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_borogove_1'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
...
insert into MultiRelationshipSlotType set slotname='slot_1', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_borogove_2'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
insert into MultiRelationshipSlotType set slotname='slot_2', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_borogove_2'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
...
insert into MultiRelationshipSlotType set slotname='uniqueBatchedSlot', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_screws_singleBatch'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
...
insert into MultiRelationshipSlotType set slotname='batchedSlot_1', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_screws_multiBatch'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
insert into MultiRelationshipSlotType set slotname='batchedSlot_2', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_screws_multiBatch'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
insert into MultiRelationshipSlotType set slotname='batchedSlot_3', multiRelationshipTypeId=(select id from MultiRelationshipType where name='boojum_screws_multiBatch'),createdBy='jrb',creationTS=UTC_TIMESTAMP();
