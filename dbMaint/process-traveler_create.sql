...
( id int NOT NULL AUTO_INCREMENT, 
  ...
  locationId int NULL COMMENT 'cached value; see also HardwareLocationHistory',
  createdBy varchar(50) NOT NULL,
  creationTS timestamp NULL,
  PRIMARY KEY (id), 
  ...
  CONSTRAINT fk6 FOREIGN KEY (locationId) REFERENCES Location(id),
...
( id int NOT NULL AUTO_INCREMENT, 
  ...
  labelGroupId int NULL COMMENT 'restrict drop-down menu of labels to a group',
  newLocation varchar(255) NULL COMMENT "set new location in this step",
  siteId int NULL COMMENT 'restrict drop-down menu of locations to a site',
  createdBy varchar(50) NOT NULL,
  creationTS timestamp NULL,
  ...
  CONSTRAINT fk47 FOREIGN KEY (labelGroupId) REFERENCES LabelGroup(id),
  CONSTRAINT fk48 FOREIGN KEY (siteId) REFERENCES Site(id),
...
( id int NOT NULL AUTO_INCREMENT, 
  ...
  activityFinalStatusId int NULL COMMENT 'Cached value; see also ActivityStatusHistory',
...
( id int NOT NULL AUTO_INCREMENT,
  name varchar(255)  NOT NULL,
  description varchar(20000) COMMENT "describe in detail",
...
(id int NOT NULL AUTO_INCREMENT,
  ...
  description varchar(20000) NULL COMMENT "if label is not sufficient",
...
(id int NOT NULL AUTO_INCREMENT,
 ...
 sha1   char(40) NOT NULL DEFAULT "0" COMMENT "still another field in fileref",
 schemaName varchar(255) NOT NULL DEFAULT "fileref",
 schemaVersion varchar(50) NOT NULL DEFAULT "0",
 schemaInstance int DEFAULT "0" COMMENT "Same schema may be used more than once in a result summary",
 activityId int NOT NULL COMMENT "activity producing this result",
 createdBy varchar(50) NOT NULL DEFAULT "ghost",
 creationTS timestamp NULL,
 PRIMARY KEY(id),
...
( id int NOT NULL AUTO_INCREMENT,
  ...
  reason varchar(20000) COMMENT 'purpose of traveler or of this version',
  subsystemId int NULL,
  createdBy varchar(50) NOT NULL,
  creationTS timestamp NULL,
  PRIMARY KEY(id),
...
(id int NOT NULL AUTO_INCREMENT,
 ...
 signerComment varchar(20000) NOT NULL DEFAULT '',
