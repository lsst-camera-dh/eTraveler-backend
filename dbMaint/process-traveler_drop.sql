...
DROP TABLE IF EXISTS BatchedRelationshipSlot;
DROP TABLE IF EXISTS BatchedRelationship;
DROP TABLE IF EXISTS BatchedRelationshipSlotType;
DROP TABLE iF EXISTS BatchedRelationshipType;
